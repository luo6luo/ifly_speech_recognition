...
speechRecognitionEntityFromJson(
    SpeechRecognitionEntity data, Map<String, dynamic> json) {
  if (json['common'] != null) {
...
Map<String, dynamic> speechRecognitionEntityToJson(
    SpeechRecognitionEntity entity) {
...
speechRecognitionCommonFromJson(
    SpeechRecognitionCommon data, Map<String, dynamic> json) {
  if (json['app_id'] != null) {
...
Map<String, dynamic> speechRecognitionCommonToJson(
    SpeechRecognitionCommon entity) {
  final Map<String, dynamic> data = {};
  data['app_id'] = entity.appId;
  return data;
}

speechRecognitionBusinessFromJson(
    SpeechRecognitionBusiness data, Map<String, dynamic> json) {
  ...
  if (json['ptt'] != null) {
    data.ptt =
        json['ptt'] is String ? int.tryParse(json['ptt']) : json['ptt'].toInt();
  }
  if (json['rlang'] != null) {
...
Map<String, dynamic> speechRecognitionBusinessToJson(
    SpeechRecognitionBusiness entity) {
  final Map<String, dynamic> data = {};
...
speechRecognitionDataFromJson(
    SpeechRecognitionData data, Map<String, dynamic> json) {
  if (json['status'] != null) {
